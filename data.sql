SELECT
 Gender, Count(Gender) as TotalCount,
...
SELECT
 Contract, Count(Contract) as TotalCount,
Count(Contract) * 100.0 / (Select Count(*) from customer_data)  as Percentage
from customer_data
Group by Contract;

SELECT
 Customer_Status, Count(Customer_Status) as TotalCount, Sum(Total_Revenue) as TotalRev,
